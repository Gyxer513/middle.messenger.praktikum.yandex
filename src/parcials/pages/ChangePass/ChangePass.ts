...
export default `
    <section class='profile__page'>
        ...
        <form class="profile__form">
            {{> input class='input_profile input_border' placeholder='Старый пароль' type='password' name='pass'}}
            {{> input class='input_profile input_border' placeholder='Новый пароль' type='password' name='pass'}}
